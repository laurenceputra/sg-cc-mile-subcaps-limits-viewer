...
- **Userscript (UOB Lady's Solitaire)** — `apps/userscripts/uob-lady-solitaire/`  
  ...
  Installable userscript: [apps/userscripts/uob-lady-solitaire/src/index.user.js](apps/userscripts/uob-lady-solitaire/src/index.user.js)
...
2. Add the script from `apps/userscripts/uob-lady-solitaire/src/index.user.js`.
